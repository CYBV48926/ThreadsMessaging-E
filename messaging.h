...
struct mailbox
{
	...
	int           mbox_id;
	/* other items as needed... */
	WaitingProcessPtr waitingSendersHead;//establishing fifo que for blocked senders
	WaitingProcessPtr waitingSendersTail;
	WaitingProcessPtr waitingReceiversHead; //establishing fifo que for blokced recievers
	WaitingProcessPtr waitingReceiversTail;
